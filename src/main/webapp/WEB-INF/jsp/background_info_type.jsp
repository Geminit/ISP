                ...
                <div class="modal-dialog modal-sm" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title" id="myModalLabel">新增变更类型</h4>
                        </div>
                    ...
                    <div class="modal-dialog modal-sm" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                ...
                                <h4 class="modal-title" id="myModalLabelEdit">变更类型编辑</h4>
                            </div>
                            <div class="modal-body">
                                <div class="form-inline">
                                    <div class="form-group">
                    ...
                    htmlobj = $.ajax({
                        ...
                        success: function (data) {
                            ...
                            var html = '<table class="table table-bordered" border="1" id="table-user">' +
                                ...
                                '<td class="success"></td><td class="success"><label>变更类型</label></td>';
