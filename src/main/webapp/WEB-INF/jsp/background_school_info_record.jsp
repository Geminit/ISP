            ...
            <div class="col-md-11" id="table-box">
                <table class="table table-bordered" border="1" id="table-user">
                    <tr>
                        ...
                        <td class="success"><label>变更前内容</label></td>
                        <td class="success"><label>变更后内容</label></td>
                    ...
                    <div class="col-md-4" id="page-button">
                        <nav>
                            <ul class="pager" id="page-controller">
                                ...
                                <c:if test="${previous>=1}">
                                    <li><a href="/schoolInfoRecord/index?page=${previous}">上一页</a></li>
                                </c:if>
                                <c:if test="${last > page}">
                                    <li class="disabled" id="last"><a href="#">下一页</a></li>
                                </c:if>
                                <c:if test="${last <= page}">
                                    <li><a href="/schoolInfoRecord/index?page=${last}">下一页</a></li>
                                </c:if>
                            </ul>
                        </nav>
                    </div>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="form-inline">
                                    <div class="form-group">
                                        <label>变更后内容:  </label>
                                        <input type="text" id="editnewinfo">
                                    </div>
                                </div>
                            </div>
                            <div class="modal-footer">
    ...
    <script>
        ...
        $(document).ready(function () {
            $("#search-btn").click(function () {
                ...
                if(text_value == ""){
                    ...
                    htmlobj = $.ajax({
                        url: "/schoolInfoRecord/searchByName",
                        type: "post",
                        scriptCharset: 'utf-8',
                        dataType: 'json',
                        data: {
        ...
        $(document).ready(function () {
            $("#newbutton").click(function () {
                htmlobj = $.ajax({
                    url: "/schoolInfoRecord/insertSchoolInfoRecord",
                    type: "post",
                    scriptCharset: 'utf-8',
                    dataType: 'json',
                    data: {
                        school_id: document.getElementById("newschool_id").value,
                        type: document.getElementById("newkind").value,
                        info: document.getElementById("newinfo").value,
                        new_info: document.getElementById("newnewinfo").value,
                    },
                    success: function (data) {
        ...
        $(document).ready(function () {
            $("#editlbutton").click(function () {
                htmlobj = $.ajax({
                    url: "/schoolInfoRecord/updateSchoolInfoRecord",
                    type: "post",
                    scriptCharset: 'utf-8',
                    dataType: 'json',
                    data: {
                        ...
                        type: document.getElementById("editkind").value,
                        info: document.getElementById("editinfo").value,
                        new_info: document.getElementById("editnewinfo").value,
                    },
                    success: function (data) {
                        var result = eval(data);
                        if(result['result']=='success'){
        ...
        function getCheckBoxEdit() {
            ...
            if(check_val.length == 1){
                //弹出模态框
                htmlobj = $.ajax({
                    url: "/schoolInfoRecord/searchById",
                    type: "post",
                    scriptCharset: 'utf-8',
                    dataType: 'json',
                    data: {
                    ...
                    success: function (data) {
                        ...
                        document.getElementById("editkind").value = dataArray[0]['type'];
                        document.getElementById("editinfo").value = dataArray[0]['info'];
                        document.getElementById("editnewinfo").value = dataArray[0]['new_info'];
                    },
                })
            }else {
                alert("请选择仅选择一个");
        ...
        function getCheckBoxDelete() {
            ...
            if(check_val.length == 1){
                htmlobj = $.ajax({
                    url: "/schoolInfoRecord/deleteSchoolInfoRecord",
                    type: "post",
                    scriptCharset: 'utf-8',
                    dataType: 'json',
                    data: {
