            ...
            <div class="col-md-11" id="table-box">
                <table class="table table-bordered" border="1" id="table-user">
                    <tr>
                        ...
                        <td class="success"></td>
                        <td class="success"><label>父母姓名</label></td>
                        <td class="success"><label>关注点</label></td>
                    </tr>
                ...
                <div class="modal-dialog modal-sm" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title" id="myModalLabel">新增关注点</h4>
                        </div>
                        <div class="modal-body">
                            <div class="form-inline">
                                <div class="form-group">
                                    <label>父母亲姓名:  </label>
                                    <input type="text" id="newparent_name">
                                </div>
                            </div>
                            <div class="form-inline">
                                <div class="form-group">
                                    <label>父母关注点:  </label>
                                    <input type="text" id="newconcern">
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="modal-dialog modal-sm" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                ...
                                <h4 class="modal-title" id="myModalLabelEdit">关注点编辑</h4>
                            </div>
                            <div class="modal-body">
                                <div class="form-inline">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="editparent_name">
                                    </div>
                                </div>
                                <div class="form-inline">
                                    <div class="form-group">
                                        <label>父母关注点:  </label>
                                        <input type="text" id="editconcern">
                                    </div>
                                </div>
                            </div>
                            <div class="modal-footer">
    ...
    <script>
        ...
        $(document).ready(function () {
            $("#search-btn").click(function () {
                ...
                if(text_value == ""){
                    ...
                    htmlobj = $.ajax({
                        url: "/parent/searchByName",
                        type: "post",
                        scriptCharset: 'utf-8',
                        dataType: 'json',
                        data: {
                            parent_name: text_value
                        },
                        success: function (data) {
                            ...
                            var html = '<table class="table table-bordered" border="1" id="table-user">' +
                                ...
                                '<td class="success"></td><td class="success"><label>父母姓名</label></td>' +
                                '<td class="success"><label>关注点</label></td>';
                            for(var i=0; i<dataArray.length; i++){
                                html += '<tr class="table-bordered"><td>'+i+1+'</td><td><input type="checkbox"></td>' +
                                    '<td>'+dataArray[i]['parent_name']+'</td><td>'+dataArray[i]['concern']+'</td>';
                            }
        ...
        $(document).ready(function () {
            $("#newbutton").click(function () {
                htmlobj = $.ajax({
                    url: "/parent/insertParent",
                    type: "post",
                    scriptCharset: 'utf-8',
                    dataType: 'json',
                    data: {
                        parent_name: document.getElementById("newparent_name").value,
                        concern: document.getElementById("newconcern").value,
                    },
                    success: function (data) {
            ...
            $("#editlbutton").click(function () {
                htmlobj = $.ajax({
                    ...
                    data: {
                        ...
                        parent_name: document.getElementById("editparent_name").value,
            ...
            if(check_val.length == 1){
                ...
                htmlobj = $.ajax({
                    ...
                    success: function (data) {
                        ...
                        document.getElementById("editparent_name").value = dataArray[0]['parent_name'];
                        document.getElementById("editconcern").value = dataArray[0]['concern'];
                    },
                })
            }else {
                alert("请选择仅选择一个");
