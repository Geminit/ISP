            ...
            <div class="col-md-11" id="table-box">
                <table class="table table-bordered" border="1" id="table-user">
                    <tr>
                        ...
                        <td class="success"></td>
                        <td class="success"><label>教师</label></td>
                    ...
                    <div class="col-md-4" id="page-button">
                        <nav>
                            <ul class="pager" id="page-controller">
                                ...
                                <c:if test="${previous>=1}">
                                    <li><a href="/story/index?page=${previous}">上一页</a></li>
                                </c:if>
                                <c:if test="${last > page}">
                                    <li class="disabled" id="last"><a href="#">下一页</a></li>
                                </c:if>
                                <c:if test="${last <= page}">
                                    <li><a href="/story/index?page=${last}">下一页</a></li>
                                </c:if>
                            </ul>
                        </nav>
                    </div>
                ...
                <div class="modal-dialog modal-sm" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title" id="myModalLabel">新增优秀事迹</h4>
                        </div>
                    ...
                    htmlobj = $.ajax({
                        ...
                        success: function (data) {
                            ...
                            var html = '<table class="table table-bordered" border="1" id="table-user">' +
                                ...
                                '<td class="success"></td><td class="success"><label>教师</label></td>' +
                                '<td class="success"><label>内容</label></td><td class="success"><label>图片</label></td>';
                            html += '<tr class="table-bordered"><td>1</td><td><input type="checkbox"></td>' +
                                '<td>'+dataArray[0]['teachere']['name']+'</td><td>'+dataArray[0]['content']+'</td>' +
                                '<td>'+dataArray[0]['image']+'</td>';
            ...
            $("#editlbutton").click(function () {
                htmlobj = $.ajax({
                    ...
                    data: {
                        ...
                        teacher_id: document.getElementById("editeacher").value,
            ...
            if(check_val.length == 1){
                ...
                htmlobj = $.ajax({
                    ...
                    success: function (data) {
                        ...
                        document.getElementById("editeacher").value = dataArray[0]['teacher_id'];
