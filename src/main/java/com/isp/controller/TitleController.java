...
public class TitleController {
    ...
    public String index(Model model, HttpServletRequest request){
        ...
        argsMap.put("end", end);
        List<Title> list = titleService.getTitleByPage(argsMap);         //SQL查询

        double number = titleService.getTotalNumber();                   //总记录条数
    ...
    public String searchByName(HttpServletRequest request){
        ...
        List<Title> list = titleService.getTitleByName(name);
    ...
    public String searchById(HttpServletRequest request){
        ...
        List<Title> list = titleService.getTitleById(id);
        JSONArray resultJson = (JSONArray) JSONArray.toJSON(list);
        String resultString = resultJson.toString();
        System.out.println(resultString);
        return resultString;
    ...
    public String insertUser(HttpServletRequest request){
        ...
        String result;
        try {
            titleService.insertTitle(argsMap);
    ...
    public String updateUser(HttpServletRequest request){
        ...
        String result;
        try {
            titleService.updateTitle(argsMap);
            result = "{'result': 'success'}";
        }catch (Exception exception){
            System.out.println(exception);
            result = "{'result': 'error'}";
